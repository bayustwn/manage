    ...
    <CardContent class="px-6 pb-6">
      <form method="post" use:enhance class="flex flex-col gap-4">
        <div class="flex flex-col gap-2">
          ...
          />
          {#if $errors.email}
            <p id="login-email-error" class="text-destructive text-xs" role="alert">{$errors.email}</p>
          {/if}
        </div>
        ...
        <div class="flex flex-col gap-2">
          ...
          {#if $errors.password}
            <p id="login-password-error" class="text-destructive text-xs" role="alert">{$errors.password}</p>
          {/if}
        </div>
